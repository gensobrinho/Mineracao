  ...
  while (true) {
    ...
    for (const edge of edges) {
      ...
      if (existingRepos.has(nameWithOwner)) {
        console.log(`⏭ Já encontrado anteriormente: ${nameWithOwner}, pulando.`);
        continue;
      }
...
async function main() {
  ...
  const queryStrings = [
    ...
    'lighthouse in:name,description,readme stars:<40000 sort:stars-desc',
    'lighthouse in:name,description,readme topic:web stars:<40000 sort:stars-desc',
    'wave in:name,description,readme stars:<40000 sort:stars-desc',
    'wave in:name,description,readme topic:web stars:<40000 sort:stars-desc',
    'lighthouse accessibility in:name,description,readme stars:<40000 sort:stars-desc',
    'wave accessibility in:name,description,readme stars:<40000 sort:stars-desc'
  ];
